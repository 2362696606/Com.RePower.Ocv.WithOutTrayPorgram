/*
 ...
 Date: 07/11/2022 15:51:02
*/


-- ----------------------------
-- Table structure for rn_db_ocv2
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[rn_db_ocv2]') AND type IN ('U'))
	DROP TABLE [dbo].[rn_db_ocv2]
GO

CREATE TABLE [dbo].[rn_db_ocv2] (
...
ALTER TABLE [dbo].[rn_db_ocv2] SET (LOCK_ESCALATION = TABLE)
GO


-- ----------------------------
-- Auto increment value for rn_db_ocv2
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[rn_db_ocv2]', RESEED, 2075079)
GO


-- ----------------------------
-- Primary Key structure for table rn_db_ocv2
-- ----------------------------
ALTER TABLE [dbo].[rn_db_ocv2] ADD CONSTRAINT [PK_rn_db_ocv2] PRIMARY KEY CLUSTERED ([ID])
