...
namespace Com.RePower.Ocv.Project.WuWei.Controllers
{
    public partial class MainWork : ObservableObject,IProjectMainWork
    {
        ...
        public MainWork(DevicesController devicesController,FlowController flowController,NgInfo ngInfo,BatteryNgCriteria batteryNgCriteria)
        {
        ...
        /// 是否复测
        /// </summary>
        public bool IsDoRetest { get; set; } = false;
        /// <summary>
        /// 复测次数
        /// </summary>
        public int RetestTimes { get; set; } = 0;
