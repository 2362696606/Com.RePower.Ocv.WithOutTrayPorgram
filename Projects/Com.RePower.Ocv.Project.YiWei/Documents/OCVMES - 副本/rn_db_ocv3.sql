/*
 ...
 Date: 07/11/2022 15:51:07
*/


-- ----------------------------
-- Table structure for rn_db_ocv3
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[rn_db_ocv3]') AND type IN ('U'))
	DROP TABLE [dbo].[rn_db_ocv3]
GO

CREATE TABLE [dbo].[rn_db_ocv3] (
...
ALTER TABLE [dbo].[rn_db_ocv3] SET (LOCK_ESCALATION = TABLE)
GO


-- ----------------------------
-- Auto increment value for rn_db_ocv3
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[rn_db_ocv3]', RESEED, 2026439)
GO


-- ----------------------------
-- Primary Key structure for table rn_db_ocv3
-- ----------------------------
ALTER TABLE [dbo].[rn_db_ocv3] ADD CONSTRAINT [PK_rn_db_ocv3] PRIMARY KEY CLUSTERED ([ID])
