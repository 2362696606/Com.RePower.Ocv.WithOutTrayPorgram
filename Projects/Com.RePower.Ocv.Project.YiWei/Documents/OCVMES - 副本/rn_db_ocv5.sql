/*
 ...
 Date: 07/11/2022 15:51:16
*/


-- ----------------------------
-- Table structure for rn_db_ocv5
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[rn_db_ocv5]') AND type IN ('U'))
	DROP TABLE [dbo].[rn_db_ocv5]
GO

CREATE TABLE [dbo].[rn_db_ocv5] (
  ...
  [END_DATE_TIME] varchar(50) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [InsertTime] varchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [TestMode] varchar(50) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [DischargeTime] decimal(18,2)  NULL
)
GO

ALTER TABLE [dbo].[rn_db_ocv5] SET (LOCK_ESCALATION = TABLE)
GO


-- ----------------------------
-- Auto increment value for rn_db_ocv5
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[rn_db_ocv5]', RESEED, 38)
GO


-- ----------------------------
-- Primary Key structure for table rn_db_ocv5
-- ----------------------------
ALTER TABLE [dbo].[rn_db_ocv5] ADD CONSTRAINT [PK_rn_db_ocv5] PRIMARY KEY CLUSTERED ([ID])
