namespace Com.RePower.Ocv.Model.Extensions
{
    public static class IntExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<bool> GetBitList(this int value)
        {
        ...
        public static bool GetBitValue(this int value, ushort index)
        {
        ...
        public static int SetBitValue(this int value, ushort index, bool bitValue)
        {
            if (index > 31) throw new ArgumentOutOfRangeException("index"); //索引出错
            var val = 1 << index;
