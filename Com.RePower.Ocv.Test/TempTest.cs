...
namespace Com.RePower.Ocv.Test
{
    public class TempTest
    {
        ...
        public void TaskTest()
        {
            ...
            OutputHelper.WriteLine("Waiting for the first 10 tasks to complete...\n");
            try
            {
            ...
            {
                OutputHelper.WriteLine("Status of tasks:\n");
                OutputHelper.WriteLine("{0,10} {1,20} {2,14:N0}", "Task Id",
                                  "Status", "Iterations");
                foreach (var t in tasks)
                    OutputHelper.WriteLine("{0,10} {1,20} {2,14}",
                                      t.Id, t.Status,
